...
echo "Test 51, w = 300:" >> output.txt
./client -n 10000 -w 300
echo "Test 52, w = 350:" >> output.txt
./client -n 10000 -w 350
echo "Test 53, w = 400:" >> output.txt
./client -n 10000 -w 400
echo "Test 54, w = 450:" >> output.txt
./client -n 10000 -w 450
echo "Test 55, w = 250:" >> output.txt
./client -n 10000 -w 500
echo "Test 56, w = 250:" >> output.txt
./client -n 10000 -w 505
echo "Finished!"
